...
def insertar():
    if request.method == 'POST':
        ...
        for i in range(3):
            ...
            Platos.append(Plato)
        #plato1#
        #NombreP1 = request.form['nombre_plato1']
        #DescripciónP1 = request.form['descripcion_plato1']
        #Preciop1 = request.form['precio_plato1']
        
        #plato2#
        #NombreP2 = request.form['nombre_plato2']
        #DescripciónP2 = request.form['descripcion_plato2']
        #Preciop2 = request.form['precio_plato2']
        #plato3#
        #NombreP3 = request.form['nombre_plato3']
        #DescripciónP3 = request.form['descripcion_plato3']
        #Preciop3 = request.form['precio_plato3']
        #Platos = [{{"Nombre": NombreP1, "Descripción": DescripciónP1 , "Precio": Preciop1}, {"Nombre": NombreP2, "Descripción": DescripciónP2 , "Precio": Preciop2}, {"Nombre": NombreP3, "Descripción": DescripciónP3 , "Precio": Preciop3}}]
        ...
        db.pedidos.insert_one({"Cliente": Cliente, "Fecha": fecha_actual , "Artículos": Articulos})
...
def actualizar():
    if request.method == 'POST':
        ...
        # Actualizar pedido
        db.pedidos.update_one({"liente":ObjectId(Cliente)}, {'$set': { "Fecha": fecha_actual, "Artículos": Articulos}})
